...
struct FlexEGPoint {
    ...
    float getTime(const MidiState& state, int channel = 0, int delay = 0) const noexcept;
    float getLevel(const MidiState& state, int channel = 0, int delay = 0) const noexcept;
