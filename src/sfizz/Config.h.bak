...
namespace config {
    ...
    */
    extern int filterControlInterval;
    /**
     ...
     *
     */
    extern unsigned delayedReleaseVoices;
} // namespace config
