...
TEST_CASE("Region activation", "Region tests")
{
    ...
    SECTION("Basic state")
    {
        ...
        layer.updateCCState(0, 4, 0_norm);
    ...
    SECTION("Single CC range")
    {
        ...
        layer.updateCCState(0, 4, 0_norm);
        REQUIRE(!layer.isSwitchedOn());
        layer.updateCCState(0, 4, 57_norm);
        REQUIRE(layer.isSwitchedOn());
        layer.updateCCState(0, 4, 56_norm);
        REQUIRE(layer.isSwitchedOn());
        layer.updateCCState(0, 4, 59_norm);
        REQUIRE(layer.isSwitchedOn());
        layer.updateCCState(0, 4, 43_norm);
        REQUIRE(!layer.isSwitchedOn());
        layer.updateCCState(0, 4, 65_norm);
        REQUIRE(!layer.isSwitchedOn());
        layer.updateCCState(0, 6, 57_norm);
        REQUIRE(!layer.isSwitchedOn());
    }
    ...
    SECTION("Multiple CC ranges")
    {
        ...
        sfz::Layer layer { region, midiState };
        layer.updateCCState(0, 4, 0_norm);
        layer.updateCCState(0, 54, 0_norm);
        REQUIRE(!layer.isSwitchedOn());
        layer.updateCCState(0, 4, 57_norm);
        REQUIRE(!layer.isSwitchedOn());
        layer.updateCCState(0, 54, 19_norm);
        REQUIRE(layer.isSwitchedOn());
        layer.updateCCState(0, 54, 17_norm);
        REQUIRE(!layer.isSwitchedOn());
        layer.updateCCState(0, 54, 27_norm);
        REQUIRE(layer.isSwitchedOn());
        layer.updateCCState(0, 4, 56_norm);
        REQUIRE(layer.isSwitchedOn());
        layer.updateCCState(0, 4, 59_norm);
        REQUIRE(layer.isSwitchedOn());
        layer.updateCCState(0, 54, 2_norm);
        REQUIRE(!layer.isSwitchedOn());
        layer.updateCCState(0, 54, 26_norm);
        REQUIRE(layer.isSwitchedOn());
        layer.updateCCState(0, 4, 65_norm);
        REQUIRE(!layer.isSwitchedOn());
    }
